...
def inject_model_hub_css() -> None:
    st.markdown(
        ...
        .d1-result-subtitle{{margin:.38rem 0 0;color:#607286;font-size:.78rem;line-height:1.5}}
        ...
        .d1-clinical-summary{{display:grid;grid-template-columns:minmax(0,1.06fr) minmax(0,.94fr);gap:0;background:#fff;border-bottom:1px solid #e4ebf0}}
        .d1-clinical-summary>div{{padding:1rem 1.2rem}}
        .d1-clinical-summary>div+div{{border-left:1px solid #e4ebf0;background:#fbfcfe}}
        ...
        .d1-clinical-item.not_assessed{{border-top-color:#6b7da8;background:#f7f8fc}}
        .d1-clinical-item-head{{display:flex;align-items:flex-start;justify-content:space-between;gap:.5rem}}
        .d1-clinical-item-head b{{color:#31465b;font-size:.73rem;line-height:1.35}}
        .d1-clinical-item-head span{{flex:0 0 auto;padding:.18rem .38rem;border-radius:999px;background:#edf1f5;color:#657487;font-size:.59rem;font-weight:800;white-space:nowrap}}
        .d1-clinical-item.provided .d1-clinical-item-head span{{background:#dcefe9;color:#0a695b}}
        .d1-clinical-item.missing .d1-clinical-item-head span{{background:#f9e8c8;color:#8b5a0b}}
