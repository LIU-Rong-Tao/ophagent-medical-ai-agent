...
FILES: dict[str, str] = {'app/checkpoints.py': '"""OphAgent 已知模型实验目录的静态发现与能力解析。"""\n'
 ...
 'app/inference.py': '"""OphAgent 单图真实 checkpoint 推理与结构化阶段错误。"""\n'
                     ...
                     '        backbone=artifact.model_key,\n'
                     '    )\n',
 'app/clinical_semantics.py': '"""把 DR 模型预测等级与输出复核优先级拆成独立展示语义。"""\n'
                              '\n'
                              'from __future__ import annotations\n'
                              '\n'
                              'import math\n'
                              ...
                              '        if not math.isfinite(severe_mass) or not 0.0 <= severe_mass '
                              '<= 1.0:\n'
                              ...
                              '        raise ValueError("review_priority 必须是 high、medium 或 '
                              'routine。")\n'
                              '\n'
 ...
 'app/ui.py': '"""OphAgent Audit Demo 的共用 Streamlit 展示组件。"""\n'
              ...
              '              <span class="oa-priority-dot" '
              'style="background:{priority_color}"></span>\n'
 ...
 'app/views/case_detail.py': '"""病例复核详情的数据隔离与 Streamlit 弹窗。"""\n'
                             ...
                             '\n'
                             '\n'
                             'def probability_values_for_case(case: Mapping[str, Any]) -> '
                             'list[float] | None:\n'
 ...
 'tests/test_clinical_semantics.py': 'import pytest\n'
                                     '\n'
                                     'from app.clinical_semantics import '
                                     'summarize_clinical_display\n'
                                     'from app.ui import build_case_card_html\n'
                                     '\n'
                                     '\n'
                                     'def '
                                     'test_severe_prediction_remains_clinically_prominent_when_audit_is_routine():\n'
                                     ...
                                     '\n'
                                     'def '
                                     'test_nonsevere_prediction_with_severe_mass_uses_possible_underestimation_wording():\n'
                                     '    summary = summarize_clinical_display(\n'
                                     '        pred_grade=2,\n'
                                     ...
                                     '    )\n'
                                     '\n'
                                     '    assert summary.predicted_grade_label == "Moderate '
                                     'DR（2级）"\n'
                                     '    assert summary.predicted_severity_band == "模型预测未达重症等级"\n'
                                     '    assert summary.audit_priority_label == "优先输出复核"\n'
                                     '    assert summary.has_possible_underestimation_signal is '
                                     'True\n'
                                     ...
                                     '\n'
                                     'def '
                                     'test_stable_mild_prediction_keeps_disease_severity_and_audit_priority_separate():\n'
                                     '    summary = summarize_clinical_display(\n'
                                     '        pred_grade=1,\n'
                                     ...
                                     '\n'
                                     'def '
                                     'test_clinical_semantics_rejects_invalid_probability_shape_and_priority():\n'
                                     ...
                                     '\n'
                                     'def '
                                     'test_clinical_semantics_can_use_existing_severe_mass_without_faking_probabilities():\n'
                                     '    summary = summarize_clinical_display(\n'
                                     '        pred_grade=2,\n'
                                     '        probabilities=None,\n'
                                     ...
                                     '\n'
                                     'def '
                                     'test_case_card_html_displays_severity_and_audit_priority_as_two_dimensions():\n'
                                     '    summary = summarize_clinical_display(\n'
                                     '        pred_grade=4,\n'
                                     '        probabilities=[0.01, 0.01, 0.03, 0.10, 0.85],\n'
                                     '        review_priority="routine",\n'
...
EXPECTED_TARGETS = [
    ...
    "tests/test_clinical_semantics.py",
